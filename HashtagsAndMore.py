...
hashtags = ['Crypto', 'Cryptocurrency', 'Etherum', 'Blockchain', 'Token', 'BTC', 'ETH', 'ETC', 'BNB', 'ZEC', 'EOS',
            'ADA', 'XRP', 'MIOTA', 'DASH', 'DODGE', 'NANO', 'CARDANO', 'LTC', 'IOTA', 'Priceupdate', 'Altcoins',
            'Innovation',
            'Climate', 'Climatechange', 'CO2', 'Energy', 'Earth', 'ClimateCrisis', 'Mining', 'Cryptomining',
            'Technology', 'Cryptonews', "XMR", "Monero"]

list_hello = ["Good evening, Mr. Graham Wu!",
              "Did you -Syu today?",
              "Nice that you found your way into our little dark room together!",
              "How did you spend your day?",
              "Hope you had a great experience, mate!", "The future will be green!",
              "Now it's time for sleep, hope just tommorow crypto will be cheap!",
              "So have good dreams about wallet full of crypto-things!", "Good day :)", "Dream about crypto!",
              "Moin! Moin!",
